...
const BoardBanner = (props) => {
    const renderSocialLinks = () => {
        ...
        return <div className="d-none d-sm-block" style={{position: "relative", bottom: "-72px"}}>
            {props.socialLinks.map((link, i) => {
                offset += 50;
                return <div key={"socialLink" + i} className="social-link p-2 px-3" style={{position: "absolute", bottom: "8px", left: (offset - 50) + "px", backgroundColor: "rgba(0,0,0,.4)"}}>
    ...
    const renderSocialLinksMobile = () => {
        ...
        return <div className="d-inline-block d-sm-none" style={{position: "relative", bottom: "-26px", height: 0}}>
            {props.socialLinks.map((link, i) => {
                return <div key={"socialLinkMobile" + i} className="d-inline social-link p-2 px-3" style={{backgroundColor: "rgba(0,0,0,.4)"}}>
    ...
    return <Col sm={12} className="mt-3">
        <Jumbotron className="mb-2 no-border small-text-shadow dark-mask"
