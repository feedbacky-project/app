...
public class StartupValidator {
  ...
  private enum EnvironmentVariables {
    ...
    MAIL_SMTP_USERNAME("0.1.0-beta"), MAIL_SMTP_PASSWORD("0.1.0-beta"), MAIL_SMTP_HOST("0.1.0-beta"),
    MAIL_SMTP_PORT("0.1.0-beta"), IMAGE_COMPRESSION_ENABLED("0.1.0-beta"),
    IMAGE_COMPRESSION_TYPE("0.1.0-beta"), IMAGE_COMPRESSION_CHEETAHO_API_KEY("0.1.0-beta"),
    SETTINGS_MAIL_LOGIN_ENABLED("1.0.0.beta.4"), MAIL_SERVICE_API_KEY("1.0.0.RC.1"), MAIL_SERVICE_API_BASE_URL("1.0.0.RC.1");
