...
const Profile = lazy(() => retry(() => import("../../views/profile/profile-view")));
const CreateBoard = lazy(() => retry(() => import("../../views/creator/create-board-view")));
...
const Board = lazy(() => retry(() => import("../../views/board-view")));
const AdminPanel = lazy(() => retry(() => import("../../views/admin/admin-panel-view")));
const Idea = lazy(() => retry(() => import("../../views/idea-view")));
