...
const ConfirmationActionModal = ({id, isOpen, onHide, onAction, actionButtonName = "Delete", actionDescription, confirmText, confirmFailMessage, ...otherProps}) => {
    ...
    return <UiDismissibleModal id={id} isOpen={isOpen} onHide={onHide} title={""} size={"md"} className={"mx-0"}
                               ...
                               }}><FaExclamation className={"move-top-1px"}/> {actionButtonName}</UiLoadableButton>} {...otherProps}>
